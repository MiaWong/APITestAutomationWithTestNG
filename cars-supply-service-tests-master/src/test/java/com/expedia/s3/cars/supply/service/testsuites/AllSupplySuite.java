...
public class AllSupplySuite {
    public void allSuiteTests() {
        ...
        final XmlPackage xmlPackage = new XmlPackage("com.expedia.s3.cars.supply.service.tests.*");
    ...
    public static void main(String... args) {
        final AllSupplySuite suite = new AllSupplySuite();
        suite.allSuiteTests();
    }
}
