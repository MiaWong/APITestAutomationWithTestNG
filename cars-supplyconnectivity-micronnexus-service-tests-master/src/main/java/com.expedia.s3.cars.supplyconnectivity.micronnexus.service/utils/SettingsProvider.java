...
import com.expedia.s3.cars.supplyconnectivity.micronnexus.service.utils.vault.PVPlatformEnsconceIntegration;
...
public class SettingsProvider
{
   ...
   public static final boolean DB_USE_PASSWORD = Boolean.parseBoolean(AppConfig.resolveStringValue("${databaseConfiguration.usePassword}"));
    public static final String DB_CARS_MICORNNEXUSSCS_DATABASE_SERVER = AppConfig.resolveStringValue("${databaseConfiguration.carsMicornNexusSCSatabaseServer}");
    public static final String DB_CARS_MICORNNEXUSSCS_DATABASE_NAME = AppConfig.resolveStringValue("${databaseConfiguration.carsMicornNexusSCSDatabaseName}");
    //Environment
     ...
     * CarSCS datasource
     */
    public static final   DataSource CARMNSCSDATASOURCE = DatabaseSetting.createDataSource(SettingsProvider.DB_CARS_MICORNNEXUSSCS_DATABASE_SERVER, SettingsProvider.DB_CARS_MICORNNEXUSSCS_DATABASE_NAME,
