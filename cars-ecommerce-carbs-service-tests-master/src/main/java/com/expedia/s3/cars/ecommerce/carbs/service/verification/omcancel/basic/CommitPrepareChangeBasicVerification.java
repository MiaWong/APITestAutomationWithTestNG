 ...
 */
public class CommitPrepareChangeBasicVerification implements IVerification<CommitPrepareChangeVerificationInput, BasicVerificationContext> {
    private static final String MESSAGR_NO_CORRECT_IN_RESPONSE = "Send Cancel---CommitPrepareChange message failed. response status not right in response!";
    ...
    @Override
    public VerificationResult verify(CommitPrepareChangeVerificationInput input, BasicVerificationContext basicVerificationContext) {
