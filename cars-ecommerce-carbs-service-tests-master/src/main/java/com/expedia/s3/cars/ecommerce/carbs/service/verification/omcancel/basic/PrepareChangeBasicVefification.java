 ...
 */
public class PrepareChangeBasicVefification implements IVerification<PrepareChangeVerificationInput, BasicVerificationContext> {
    private static final String MESSAGR_NO_CORRECT_IN_RESPONSE = "Send Cancel---PrepareChange message failed. response status not right in response!";
    ...
    @Override
    public VerificationResult verify(PrepareChangeVerificationInput input, BasicVerificationContext basicVerificationContext) {
