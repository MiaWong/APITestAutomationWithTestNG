...
public class VerifyMediaDataReserve {

    public static void verifyMediaData(PreparePurchaseResponseType input, BasicVerificationContext context, String bsClientGDSConfigValue, String acrissClientConfig) throws DataAccessException{
        ...
        if(CompareUtil.isObjEmpty(input)){
            Assert.fail("Response is null.");
        }
        @SuppressWarnings("CPD-START")
        final List<BookedItemType> bookedItemList = input.getPreparedItems().getBookedItemList().getBookedItem();
