...
public class EndToEndSuite {
    ...
    public void e2eSuiteTests() {
        ...
        suite.setName("Titanium E2E Tests");
        ...
        final XmlClass xmlClass = new XmlClass("com.expedia.s3.cars.supplyconnectivity.titanium.service.tests.com.expedia.s3.cars.ecommerce.carbs.service.testsuites.com.expedia.s3.cars.ecommerce.carbs.service.tests.bvt.EndToEnd");
