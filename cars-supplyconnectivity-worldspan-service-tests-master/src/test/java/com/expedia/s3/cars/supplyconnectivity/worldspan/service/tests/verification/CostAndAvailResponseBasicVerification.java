 ...
 */
public class CostAndAvailResponseBasicVerification implements IGetCostAndAvailabilityVerification {
    ...
    public static void verifyCarLocationInfo(BasicVerificationContext basicVerificationContext,CarSupplyConnectivityGetCostAndAvailabilityResponseType response, DataSource carWorldSpandataSource,DataSource carsInventorydatasource) throws DataAccessException {
    ...
    private static void verifySCSResCarLocationInfo(CarSupplyConnectivityGetCostAndAvailabilityResponseType response, DataSource carsInventorydatasource) throws DataAccessException {
        StringBuilder errorMsg = new StringBuilder("");
