...
public class GetDetailsBasicVerification implements IGetDetailsVerification {
    ...
    public static void verifyCarLocationInfo(BasicVerificationContext basicVerificationContext,CarSupplyConnectivityGetDetailsResponseType response, DataSource carWorldSpandataSource,DataSource carsInventorydatasource) throws DataAccessException {
    ...
    private static void verifySCSResCarLocationInfo(CarSupplyConnectivityGetDetailsResponseType response, DataSource carsInventorydatasource) throws DataAccessException {
        StringBuilder errorMsg = new StringBuilder("");
