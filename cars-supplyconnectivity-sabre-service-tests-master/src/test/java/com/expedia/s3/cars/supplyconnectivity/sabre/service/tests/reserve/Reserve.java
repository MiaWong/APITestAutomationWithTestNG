...
public class Reserve extends SuiteContext
{
    ...
    public void casss4437USAReserveOnAirport() throws Exception
    {
        ...
        testReserve( scenario, "4437", randomGuid,false);
    }

    @Test(retryAnalyzer = RetryAnalyzer.class, groups = {TestGroup.BOOKING_REGRESSION})
    public void casss4437USAReserveOffAirport() throws Exception
    {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, groups = {TestGroup.BOOKING_REGRESSION})
    public void casss4437CANReserveOnAirport() throws Exception
    {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, groups = {TestGroup.BOOKING_REGRESSION})
    public void casss4437CANReserveOffAirport() throws Exception
    {
    ...
    public void casss4437USAReserveWithSpecialEquipment() throws Exception
    {
        final TestScenario scenario = CommonScenarios.Sabre_USA_Standalone_RoundTrip_OffAirport_LAS.getTestScenario();
        final String randomGuid = Utils.setSpooferOverride(spooferTransport,scenario.getScenarionName());
        testReserve( scenario, "4437", randomGuid,true);
    }

    // Commenting out the test case as there is some issue with the mapping of special equipment in SabreSCS.
    //@Test(groups = {TestGroup.BOOKING_REGRESSION})
    public void casss4437CANReserveWithSpecialEquipment() throws Exception
    {
        final TestScenario scenario = CommonScenarios.Sabre_CAN_Standalone_Oneway_OnAirport_YOW.getTestScenario();
        final String randomGuid = Utils.setSpooferOverride(spooferTransport,scenario.getScenarionName());
        testReserve( scenario, "4437", randomGuid,true);
                             ...
                             boolean isRequiredSpecialEquipment) throws Exception
    {
        ...
        ReserveHelper.reserveVerify(reserveVerificationInput, spooferTransport, scenarios, newguid, isRequiredSpecialEquipment, logger, true);
