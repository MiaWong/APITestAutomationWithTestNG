...
public class GetReservation extends SuiteContext
{
    ...
    public void casss4461USAgetReserveOnAirport() throws Exception
    {
        ...
        testGetReservation(scenario, "4461", randomGuid);
    }

    @Test(retryAnalyzer = RetryAnalyzer.class, groups = {TestGroup.BOOKING_REGRESSION})
    public void casss4461USAgetReserveOffAirport() throws Exception
    {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, groups = {TestGroup.BOOKING_REGRESSION})
    public void casss4461CANgetReserveOnAirport() throws Exception
    {
    ...
    @Test(retryAnalyzer = RetryAnalyzer.class, groups = {TestGroup.BOOKING_REGRESSION})
    public void casss4461CANgetReserveOffAirport() throws Exception
    {
